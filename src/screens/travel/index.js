...
const Travel = () => {
    ...
    return (
        <UserLayout>
            ...
            <Helmet>
                <meta charSet="utf-8" />
                <title>Manage Travel & Hospitality Business with Custom Software  </title>
                <meta name="Application development services by Techverse LLC for travel & hospitality. Work with fingertips to book hotels and air tickets worldwide. " />
            </Helmet>
            <HeroSection
