...
const Portfolios = (props) => {
    return (
              ...
              <div class="col-md-12">
                <div class="portfolio_tabs nav nav-tabs" id="myTab" role="tablist" data-aos="fade-up" data-aos-offset="0" data-aos-duration="3000">
                  <a class="nav-link active"
                   id="mobile_apps" data-toggle="tab"
                    href="#mobile-app" role="tab">
                      Mobile Apps
                </a>
                <a class="nav-link"
                id="websites_tab" data-toggle="tab"
        ...
        <SwiperSlide> <img src={props?.image1} alt="" /></SwiperSlide>
        <SwiperSlide> <img src={props?.image2} alt="" /></SwiperSlide>
        <SwiperSlide> <img src={props?.image3} alt="" /></SwiperSlide>
        <SwiperSlide> <img src={props?.image4} alt="" /></SwiperSlide>
        <SwiperSlide> <img src={props?.image5} alt="" /></SwiperSlide>
        <SwiperSlide> <img src={props?.image1} alt="" /></SwiperSlide>
        <SwiperSlide> <img src={props?.image2} alt="" /></SwiperSlide>
